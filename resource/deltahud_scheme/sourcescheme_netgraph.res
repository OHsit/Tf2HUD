//taken form https://www.dodbits.com/dods/index.php/source-graphics/source-gui-hud-tutorials/change-the-netgraph-font-size
Scheme
{
    ...
    Fonts
    {
        ...
        "DefaultFixedOutline" //edited by INsane 2010 for small netgraph font on all screen sizes
        {
            ...
            {
                "name"         "VCR OSD Mono" [$WINDOWS] // Standard is "Lucida Console" Options are "Microsoft Sans Serif" "Georgia" "Impact" "Arial MT" and the best for small = "Haettenschweiler" but is a MS office and Win7 font, can be downloaded, google "Haettenschweiler" and install in C:/Windows/Fonts
            ...
            {
                "name"         "VCR OSD Mono" [$WINDOWS] // Standard is "Lucida Console" Options are "Microsoft Sans Serif" "Georgia" "Impact" "Arial MT" and the best for small = "Haettenschweiler" but is a MS office and Win7 font, can be downloaded, google "Haettenschweiler" and install in C:/Windows/Fonts1"                
